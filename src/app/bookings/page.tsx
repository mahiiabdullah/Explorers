...
const MOCK_BOOKINGS: Booking[] = [
  {
    ...
    screen: { id: 4, name: '4' },
    seats: [{ id: 'E5', row: 'E', col: 5, seatType: 'premium', priceModifier: 1, status: 'available' }],
  ...
  },
  {
    ...
    userId: 'user_1',
    showtimeId: 87,
    movie: { id: 2, title: 'Inception 2', posterUrl: '', durationMin: 148, rating: 8.4 },
    theatre: { id: 2, name: 'INOX Forum' },
    screen: { id: 7, name: '7' },
    seats: [{ id: 'B3', row: 'B', col: 3, seatType: 'regular', priceModifier: 1, status: 'available' }],
